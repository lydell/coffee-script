...
(function() {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      answer.push(this.makeCode('}'));
      this.eachParamName(function(name, node) {
        var column, fragment, inParamList, index, last, lastFnStart, len7, line, next, ref9, results, s, waitUntil;
        if (name.charAt(0) !== '@') {
          return;
        }
        inParamList = false;
        ...
        waitUntil = null;
        results = [];
        for (index = s = 0, len7 = answer.length; s < len7; index = ++s) {
          fragment = answer[index];
          if (waitUntil) {
            if (!(fragment.locationData && fragment.locationData.first_line >= waitUntil.last_line && fragment.locationData.first_column >= waitUntil.last_column)) {
              continue;
            }
            waitUntil = null;
            inParamList = false;
          ...
          if (inParamList && fragment.type === 'Literal' && fragment.code === name.slice(1)) {
            waitUntil = lastFnStart.locationData;
            continue;
          }
          last = answer[index - 1];
          next = answer[index + 1];
          if (inParamList || (last != null ? last.type : void 0) === 'Access' || (next != null ? next.code : void 0) === ': ' || ((last != null ? last.type : void 0) === 'Assign' && (last != null ? last.locationData : void 0) === void 0)) {
            continue;
          }
          if (fragment.type === 'Literal' && fragment.code === name.slice(1)) {
            ref9 = fragment.locationData, line = ref9.first_line, column = ref9.first_column;
            results.push(console.error(o.filename + ":" + (line + 1) + ":" + (column + 1) + ": Rename " + fragment.code + " to " + name));
          } else {
            results.push(void 0);
          }
        }
